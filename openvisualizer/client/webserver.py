...
class WebServer:
    ...
    def _define_routes(self):
        ...
        self.bottle_srv.route(path='/advanced_topology', callback=self._advanced_topology_page)
        self.bottle_srv.route(path='/advanced_topology/data', callback=self._advanced_topology_data)
    ...
    @bottle.view('advanced_topology.tmpl')
    def _advanced_topology_page(self):
        """ Retrieve the HTML/JS page. """
        return {}
    
    def _advanced_topology_data(self):
        """ Retrieve the topology data, in JSON format. """
        data = {}
        try:
            data = self.rpc_server.get_network_topology()
